			...
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li><a href="categories.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Phụ kiện</a></li>
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Đồng hồ</a></li>
					</ul>
				</div>
					...
					<div class="row">
						...
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(images/<?php echo $r['hinhanh']?>)"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					<div class="product_details_title">
						<h2><?php echo $r['tensp']?></h2>
						<p><?php echo $r['mota']?></p>
					</div>
					<div class="free_delivery d-flex flex-row align-items-center justify-content-center">
						<span class="ti-truck"></span><span>free delivery</span>
					</div>
					<div class="product_price"><?php echo $r['gia']?>.00đ</div>
