...
<!--C O N T A I N E R-->
<div class="container">
  <h3>CD store quản lí -Xóa sản phẩm</h3>
  <?php
        ...
        foreach($data as $r)
        {
            ?>
                <div class="row">
                    <div class="col img">
                        <div>
                            <img src="../../../images/<?php echo $r->hinhanh?>" alt="h1">
                        </div>
                    </div>
                    <div class="col-7 ">
                        <div>
                        ...
                        <div>
                            <a href="./process_delete.php?pd_id=<?php echo $r->id_sp?>"><button type="submit" class="btn btn-danger">Delete</button></a>
                        </div>
                    </div><hr>
                </div><hr id="end">
            <?php
