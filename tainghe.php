		...
		<div class="row">
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="index.php">Home</a></li>
						<li class="active"><a href="categories.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Phụ kiện</a></li>
					</ul>
				</div>
					...
					<div class="products_iso">
						<div class="row">
							<div class="col">
								...
								chitietsp.mahinh=hinhanh.mahinh where maloai='$maloai'";
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="footer_nav_container">
						<div class="cr">©2022 All Rights Reserverd. Template by <a href="#">CD Store</a> &amp; distributed by <a href="https://themewagon.com">ThemeWagon</a></div>
					</div>
				</div>
			</div>
		</div>
